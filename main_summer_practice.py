            ...
            if color.isValid():
                ...
                if ok and styleName:
                    ...
                    if ok:
                        ...
                        self.parent().applyTextStyle(charFormat, alignment, margins)
...
class MyWidget(QMainWindow):
    ...
    def applyDefaultStyle(self):
        ...
        if styleName in self.styles:
            ...
            alignment = style.get("alignment", "Left")
            margins = style.get("margins", {"left": 0, "right": 0})
            self.applyTextStyle(charFormat, alignment, margins)
    ...
    def applyTextStyle(self, charFormat, alignment, margins=None):
        cursor = self.textEdit.textCursor()
        ...
        if cursor.hasSelection():
            ...
            if cursor.selectedText() == "":
                cursor.insertText(" ")  # Вставляем пробел
