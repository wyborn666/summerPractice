...
class MarginsDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Установка отступов")
...
class StyleDialog(QDialog):
    def __init__(self, parent=None):
        ...
        # Add alignment selection
        self.alignmentComboBox = QComboBox(self)
        self.alignmentComboBox.addItems(["Left", "Center", "Right", "Justify"])
        self.alignmentComboBox.hide()
        self.layout.addWidget(self.alignmentComboBox)
                ...
                if ok and styleName:
                    ...
                    if ok:
                        ...
                        self.styles[styleName] = {
                            ...
                            "color": color.name(),
                            "alignment": alignment  # Сохраняем выравнивание
                        }
                        self.updateComboBox()
                        self.parent().saveStyles(self.styles)  # Сохраняем стили
                        # Применяем стиль
                        self.parent().applyTextStyle(charFormat, alignment)
...
class MyWidget(QMainWindow):
    ...
    def applyTextStyle(self, charFormat, alignment):
        cursor = self.textEdit.textCursor()
        if cursor.hasSelection():
